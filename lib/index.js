...
function mapInput(props) {
  ...
  if (value != null) {
    ...
    value = _immutable.Map.isMap(value) ? value : (0, _immutable.Map)(value);

    return _react2.default.createElement('div', { key: instanceKey }, value.keySeq().map(function renderObjectKeys(key, index) {
...
mapInput.propTypes = {
  value: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.object, _reactImmutableProptypes2.default.map]),
  serializedPath: _react2.default.PropTypes.array
};
