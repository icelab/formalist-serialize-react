...
function many(props) {
  ...
  return _react2.default.createElement('div', null, children.count() > 0 ? children.map(function renderSet(children, setIndex) {
...
function list(props) {
  ...
  return _react2.default.createElement('div', null, value ? value.map(function renderValue(value, index) {
